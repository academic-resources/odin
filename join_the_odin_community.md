...
\`Your Code\`** ** For multiple lines of code:**  use three backticks _on a separate line_ above and below your code :**

\`\`\`** Your Multiple Lines of Code** \`\`\`** You can also use _code highlighting_ to add color to your multi-line code by specifying the language:** ** 
...
---** # Challenge:** <div class="lesson-content__panel" markdown="1">**   1. First, create a free [GitHub account](https://github.com/join). As you will discover, GitHub is an integral part of the development workflow :**
...
If they have not reached that portion of the curriculum, let them know they will learn it in the future. ** If they have already been through that portion of the curriculum, politely direct to review that lesson :**
