...
<img src="https://i.imgur.com/ZKrMLCR.png">** After entering the keyboard shortcuts window,  access all of the emmet actions by searching for `Emmet:<action>`. In our case, it will be `Emmet:Wrap With Abbreviation`
