...
### The History of JavaScript** Why do we even need or want this stuff? What do you gain from all of this added complexity? These are good questions.. with good answers :**
...
### ES6 Modules (finally!)** Now that we (sorta) understand what webpack is doing it's time to discuss the module syntax. There are only 2 components to it - __import__ and __export__ :**
...
└── webpack.config.js
```
** In addition,  bundle and run webpack by simply typing `npx webpack` in the terminal :**
