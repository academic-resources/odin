...
`clamp(minimum-size, ideal-size, maximum-size)`** What this does is allow our item to resize itself until it reaches one of the minimum or maximum threshold values :**
