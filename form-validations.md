...
#### ** ** Maximum Length Validation** To add a maximum length validation, we give the form control an `maxlength` attribute with an integer value which represents the maximum amount of characters we want to allow in the form control:** ** 
...
#### ** ** Combining Validations** HTML allows us to apply as many validations as we wish to a form controls. For example, we can give our tweet textarea both `minlength` and `maxlength` validations:** ** 
...
#### ** ** Min Validation** To add a minimum value validation, we give the form control a `min` attribute with an integer value which represents the minimum number we want the form control to accept:** ** 
...
#### ** ** Max Validation** To add a maximum value validation, we give the form control a `max` attribute with an integer value which represents the maximum number we want the form control to accept:** ** 
